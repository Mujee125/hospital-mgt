...
//   { to: "/", label: "Dashboard", icon: LayoutDashboard, end: true, requiredPermission: PERMISSIONS.DashboardView },
//   { to: "/appointments", label: "Appointments", icon: Calendar, requiredPermission: PERMISSIONS.AppointmentsView },
//   { to: "/patients", label: "Patients", icon: Users, requiredPermission: PERMISSIONS.PatientsView },
//   { to: "/queue", label: "Queue", icon: ListOrdered, requiredPermission: PERMISSIONS.QueueView },
//   { to: "/doctors", label: "Doctors", icon: Stethoscope, requiredPermission: PERMISSIONS.DoctorsView },
//   { to: "/ipd", label: "In-Patient", icon: BedDouble, requiredPermission: PERMISSIONS.IpdView },
//   { to: "/laboratory", label: "Laboratory", icon: FlaskConical, requiredPermission: PERMISSIONS.LabView },
//   { to: "/billing", label: "Billing", icon: Receipt, requiredPermission: PERMISSIONS.BillingView },
//   { to: "/messaging", label: "Staff chat", icon: MessageSquare, badge: "Live" },
//   { to: "/audit", label: "Audit log", icon: ScrollText, requiredPermission: PERMISSIONS.AuditView },
//   { to: "/users", label: "Users & roles", icon: UserCog, requiredPermission: PERMISSIONS.UsersView },
//   { to: "/reports", label: "Reports", icon: BarChart3, disabled: true, note: "Phase 2" },
//   { to: "/settings", label: "Settings", icon: Settings, requiredPermission: PERMISSIONS.SettingsManage },
// ];
...
//   return (
//     <aside
//       className="flex flex-col h-full border-r border-white/10 select-none transition-[width] duration-200 ease-[cubic-bezier(0.22,1,0.36,1)]  border-none"
//       style={{
//         width: isMobileDrawer ? "100%" : showExpanded ? "264px" : "72px",
//         background:
//           "linear-gradient(to bottom, hsl(var(--sidebar-bg)) 0%, hsl(var(--sidebar-bg-2)) 100%)",
//       }}
//     >
//       {/* Brand */}
//       <div
